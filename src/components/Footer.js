...
export const Footer = () => {
  return (
      ...
      <footer className="bg-white  shadow m-4 dark:bg-darkbg">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between ">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link to="/" className="hover:underline">Cinema mate</Link>. All Rights Reserved.</span>
